...
import com.kotlin2023.listacomidaapplication.databinding.ActivityMainBinding
...
class MainActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        binding.btnPedido.setOnClickListener {
            ...
            i.putExtra("qtd_pao", binding.editQtdPao.text.toString())
            i.putExtra("qtd_chocolate", binding.editQtdChocolate.text.toString())
